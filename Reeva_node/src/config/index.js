...
export const config = {
  ...
  dynamodb: {
    tablas: {
      ...
      items: process.env.ITEMS_TABLE || 'empresa-items',
      itemsMesas: process.env.ITEMS_MESAS_TABLE || 'items-mesas',
      ...
      espacios: process.env.ESPACIOS_TABLE || 'espacios',
      ocupantes: process.env.OCUPANTES_TABLE || 'ocupantes',
      empresas: process.env.EMPRESAS_TABLE || 'empresas-new',
    },
  },
