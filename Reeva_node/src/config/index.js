...
export const config = {
  ...
  dynamodb: {
    tablas: {
      ...
      items: process.env.ITEMS_TABLE || 'aws-cognito-jwt-login-dev-items',
      itemsMesas: process.env.ITEMS_MESAS_TABLE || 'aws-cognito-jwt-login-dev-items-mesas',
      ...
      espacios: process.env.ESPACIOS_TABLE || 'aws-cognito-jwt-login-dev-espacios',
      ocupantes: process.env.OCUPANTES_TABLE || 'aws-cognito-jwt-login-dev-ocupantes',
      empresas: process.env.EMPRESAS_TABLE || 'aws-cognito-jwt-login-dev-empresas-new',
    },
  },
